...
HOUGH_PARAM2    = 0.85
HOUGH_MIN_R_RAT = 0.05
HOUGH_MAX_R_RAT = 0.49
HOUGH_MIN_DIST_RAT = 0.1
...
class DetectorConfig:
    ...
    # 霍夫参数
    hough_param2: float =       HOUGH_PARAM2            #霍夫判定权重阈值
    hough_min_r_rat: float =    HOUGH_MIN_R_RAT         #最小圆半径
    hough_max_r_rat: float =    HOUGH_MAX_R_RAT         #最大圆半径
    hough_min_dist_rat: float = HOUGH_MIN_DIST_RAT      #圆心间距
